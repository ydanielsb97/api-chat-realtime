...
let User = class User {
    hashPassword() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.password = yield bcrypt_1.hash(this.password, 10);
        });
    }
...
__decorate([
    type_graphql_1.Field(() => [Message_entity_1.Message]),
    typeorm_1.OneToMany(() => Message_entity_1.Message, message => message.user),
